...
"""The ``uuid`` field type — an opaque identifier stored as canonical text."""
...
class UUIDType(FieldTypeHandler):
    type_id = FieldType.uuid.value
    ...
    def normalize(self, value: object, *, config: BaseModel) -> JsonValue:
        ...
        try:
            ...
            raise ValueError(f"{value!r} is not a UUID") from None
