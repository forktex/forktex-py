...
"""forktex.agent.engine.process — AgentProcess wraps an AgentLoop with identity and state.

Each AgentProcess has a unique ID, type, status, and optional parent.
It delegates actual work to AgentLoop.
"""
...
from forktex.agent.engine.types import AgentType
from forktex.agent.engine.loop import AgentLoop, AgentResponse
...
class AgentProcess:
    ...
    _loop: Optional[AgentLoop] = field(default=None, repr=False)
